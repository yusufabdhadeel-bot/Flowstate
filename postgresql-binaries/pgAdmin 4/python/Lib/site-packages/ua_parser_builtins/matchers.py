...
MATCHERS: Tuple[List[UserAgentMatcher], List[OSMatcher], List[DeviceMatcher]] = ([
    ...
    UserAgentMatcher('(RuxitSynthetic)/(\\d+)\\.(\\d+)', 'Ruxit Synthetic'),
    ...
    UserAgentMatcher('(Instagram) (\\d+)\\.(\\d+)\\.(\\d+)'),
    ...
    UserAgentMatcher('(Telegram-Android)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Telegram'),
    ...
    UserAgentMatcher('(Camoufox) Camoufox (\\d+)\\.(\\d+)'),
    ...
    UserAgentMatcher('(UC? ?Browser|UCWEB|UCMobile|U3)[ /]?(\\d+)\\.(\\d+)\\.(\\d+)', 'UC Browser'),
    ...
    UserAgentMatcher('(OPX)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)', 'Opera GX'),
    UserAgentMatcher('(OPT)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)', 'Opera Touch'),
    ...
    UserAgentMatcher('(?:\\()?Brave(?:\\))?\\s*$', 'Brave'),
    ...
    UserAgentMatcher('(HonorBrowser)/(\\d+)\\.(\\d+)\\.(\\d+)(?:\\.(\\d+)|)', 'Honor Browser'),
    ...
    UserAgentMatcher('(SLBrowser)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Smart Lenovo Browser'),
    ...
    UserAgentMatcher('(MicroMessenger)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)', 'WeChat Browser'),
    UserAgentMatcher('(Odin)/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', 'Odin'),
    UserAgentMatcher('(Colt)/(\\d+)\\.(\\d+)', 'NetCast Smart TV'),
    UserAgentMatcher('(Lite Browser)/(\\d+)\\.(\\d+)', 'Lite Browser'),
    UserAgentMatcher('(OMI)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Vewd Browser'),
    UserAgentMatcher('(Mypal)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Mypal Browser'),
    UserAgentMatcher('(Chesscom-Android)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentMatcher('(RobloxApp)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Roblox App'),
    UserAgentMatcher('(Roadrunner)/IOS/\\d+/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentMatcher('(AncestryAndroid)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)'),
    ...
    UserAgentMatcher('(QtWebEngine)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Qt Web Engine'),
    UserAgentMatcher('(OpenWave)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Open Wave'),
    UserAgentMatcher('(AtContent)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentMatcher('(Trailer)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentMatcher('(Agency)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentMatcher('(Herring)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentMatcher('(Config)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentMatcher('(Viewer)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentMatcher('(LikeWise)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentMatcher('(Unique)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentMatcher('(CitizenFX)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentMatcher('(R2Client)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)'),
    UserAgentMatcher('(OBS)/(\\d+)\\.(\\d+)\\.(\\d+)', 'OBS Studio'),
    UserAgentMatcher('(AdobeCEP)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Adobe CEP'),
    UserAgentMatcher('Valve Steam (GameOverlay).{1,200}Chrome/(\\d+)\\.(\\d+)\\.(\\d+)', 'Steam GameOverlay'),
    UserAgentMatcher('Valve Steam (Gamepad)/Steam Deck.{1,200}Chrome/(\\d+)\\.(\\d+)\\.(\\d+)', 'Steam Deck'),
    UserAgentMatcher('(Valve(?: Steam|) Client).{1,200}Chrome/(\\d+)\\.(\\d+)\\.(\\d+)', 'Steam Client'),
