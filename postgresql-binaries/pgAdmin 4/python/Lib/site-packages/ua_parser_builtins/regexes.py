...
USER_AGENT_PARSERS = [
    ...
    UserAgentParser('(RuxitSynthetic)/(\\d+)\\.(\\d+)', 'Ruxit Synthetic'),
    ...
    UserAgentParser('(Instagram) (\\d+)\\.(\\d+)\\.(\\d+)'),
    ...
    UserAgentParser('Mozilla.{1,200}Mobile.{1,100}(KAKAOTALK)/(\\d+)\\.(\\d+)\\.(\\d+)', 'KakaoTalk'),
    UserAgentParser('(Telegram-Android)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Telegram'),
    ...
    UserAgentParser('(Camoufox) Camoufox (\\d+)\\.(\\d+)'),
    ...
    UserAgentParser('(UC? ?Browser|UCWEB|UCMobile|U3)[ /]?(\\d+)\\.(\\d+)\\.(\\d+)', 'UC Browser'),
    ...
    UserAgentParser('(OPX)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)', 'Opera GX'),
    UserAgentParser('(OPT)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)', 'Opera Touch'),
    ...
    UserAgentParser('(AlohaBrowser|ABB)/(\\d+)\\.(\\d+)\\.(\\d+)(?:\\.(\\d+)|)', 'Aloha Browser'),
    UserAgentParser('((?:B|b)rave(?:\\sChrome)?)/(\\d+)(?:\\.(\\d+)|)(?:\\.(\\d+)|)(?:\\.(\\d+)|)', 'Brave'),
    UserAgentParser('(?:\\()?Brave(?:\\))?\\s*$', 'Brave'),
    ...
    UserAgentParser('(OculusBrowser)/(\\d+)\\.(\\d+)(?:\\.([0-9\\-]+)|)', 'Oculus Browser'),
    ...
    UserAgentParser('(FlyFlow|flyflow|baiduboxapp)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)(?:\\.(\\d+)|)', 'Baidu Explorer'),
    ...
    UserAgentParser('(H[Ii]Browser)\\/v(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', 'HiBrowser'),
    UserAgentParser('(HonorBrowser)/(\\d+)\\.(\\d+)\\.(\\d+)(?:\\.(\\d+)|)', 'Honor Browser'),
    UserAgentParser('(bdhonorbrowser)/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', 'Honor Browser'),
    UserAgentParser('(HeyTapBrowser)/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', 'HeyTap Browser'),
    UserAgentParser('(weibo)__(\\d+)\\.(\\d+)\\.(\\d+)', 'Weibo'),
    UserAgentParser('(WeiboliteiOS|WeiboIntliOS)', 'Weibo'),
    UserAgentParser('(PHX)/(\\d+)\\.(\\d+)', 'Phoenix Browser'),
    ...
    UserAgentParser('(115Browser)/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', '115 Browser'),
    UserAgentParser('(Avira)/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', 'Avira'),
    UserAgentParser('(CCleaner)/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', 'CCleaner'),
    UserAgentParser('(Norton)/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', 'Norton'),
    UserAgentParser('(Quark)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Quark'),
    UserAgentParser('(QuarkPC)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Quark PC'),
    UserAgentParser('(SLBrowser)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Smart Lenovo Browser'),
    UserAgentParser('(Atom)/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', 'Atom Browser'),
    UserAgentParser('(Chrome)/\\d+\\.\\d+\\.\\d+\\.\\d+ .* QIHU 360(?:SEi18n|ENT)', '360 Secure Browser'),
    UserAgentParser('(Decentr)', 'Decentr Web3 Browser'),
    UserAgentParser('(Sparrow)', 'Sparrow Browser'),
    UserAgentParser('(Chromium GOST)', 'Chromium GOST Browser'),
    UserAgentParser('(AOLShield)/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', 'AOL Shield Browser'),
    UserAgentParser('(Hola)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Hola Browser'),
    UserAgentParser('(CravingExplorer)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Craving Explorer Browser'),
    UserAgentParser('(Talon)', 'Talon Cyber Security Browser'),
    UserAgentParser('(Qaxbrowser)', 'QAX Browser'),
    UserAgentParser('(ADG)/(\\d+)\\.(\\d+)\\.(\\d+)', 'AOL Desktop Gold Browser'),
    UserAgentParser('(SberBrowser)/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', 'Sber Browser'),
    UserAgentParser('(JiSu)/(\\d+)\\.(\\d+)\\.(\\d+)', 'JiSu Browser'),
    UserAgentParser('(Wolvic)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Wolvic Browser'),
    UserAgentParser('(Thano)/(\\d+)\\.(\\d+)', 'SmartTV WebBrowser'),
    UserAgentParser('(MicroMessenger)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)', 'WeChat Browser'),
    UserAgentParser('(Odin)/(\\d+)\\.(\\d+)\\.(\\d+)\\.(\\d+)', 'Odin'),
    UserAgentParser('(Colt)/(\\d+)\\.(\\d+)', 'NetCast Smart TV'),
    UserAgentParser('(Lite Browser)/(\\d+)\\.(\\d+)', 'Lite Browser'),
    UserAgentParser('(OMI)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Vewd Browser'),
    UserAgentParser('(Mypal)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Mypal Browser'),
    UserAgentParser('(Chesscom-Android)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(RobloxApp)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Roblox App'),
    UserAgentParser('(Roadrunner)/IOS/\\d+/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(AncestryAndroid)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)'),
    ...
    UserAgentParser('(QtWebEngine)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Qt Web Engine'),
    UserAgentParser('(OpenWave)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Open Wave'),
    UserAgentParser('(AtContent)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(Trailer)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(Agency)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(Herring)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(Config)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(Viewer)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(LikeWise)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(Unique)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(CitizenFX)/(\\d+)\\.(\\d+)\\.(\\d+)'),
    UserAgentParser('(R2Client)/(\\d+)\\.(\\d+)(?:\\.(\\d+)|)'),
    UserAgentParser('(OBS)/(\\d+)\\.(\\d+)\\.(\\d+)', 'OBS Studio'),
    UserAgentParser('(AdobeCEP)/(\\d+)\\.(\\d+)\\.(\\d+)', 'Adobe CEP'),
    UserAgentParser('Valve Steam (GameOverlay).{1,200}Chrome/(\\d+)\\.(\\d+)\\.(\\d+)', 'Steam GameOverlay'),
    UserAgentParser('Valve Steam (Gamepad)/Steam Deck.{1,200}Chrome/(\\d+)\\.(\\d+)\\.(\\d+)', 'Steam Deck'),
    UserAgentParser('(Valve(?: Steam|) Client).{1,200}Chrome/(\\d+)\\.(\\d+)\\.(\\d+)', 'Steam Client'),
...
DEVICE_PARSERS = [
    DeviceParser('^.{0,100}?(?:(?:iPhone|Windows CE|Windows Phone|Android).{0,300}(?:(?:Bot|Yeti)-Mobile|YRSpider|BingPreview|bots?/\\d|(?:bot|spider)\\.html|Google-InspectionTool)|AdsBot-Google-Mobile.{0,200}iPhone)', 'i', 'Spider', 'Spider', 'Smartphone'),
    ...
    DeviceParser('; {0,2}(ADR6200|ADR6400L|ADR6425LVW|Amaze|DesireS?|EndeavorU|Eris|EVO|Evo\\d[A-Z]+|HD2|IncredibleS?|Inspire[A-Z0-9]*|Sensation[A-Z0-9]*|Wildfire)[ _-](.{1,200}?)(?:[/;\\)]|Build|MIUI|1\\.0)', 'i', 'HTC $1 $2', 'HTC', '$1 $2'),
